...
namespace AbpPoc.EntityFrameworkCore.Domains.Parts
{
    public class PartRepositoryTests : AbpPocEntityFrameworkCoreTestBase
    {
        ...
        public async Task GetListAsync()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.First().Id.ShouldBe(Guid.Parse("218e0563-5ee5-407f-a06c-591425acceb9"));
            });
        }
