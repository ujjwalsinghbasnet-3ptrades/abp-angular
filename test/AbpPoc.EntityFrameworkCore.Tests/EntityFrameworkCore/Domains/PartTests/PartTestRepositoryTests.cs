...
namespace AbpPoc.EntityFrameworkCore.Domains.PartTests
{
    public class PartTestRepositoryTests : AbpPocEntityFrameworkCoreTestBase
    {
        private readonly IPartTestRepository _partTestRepository;

        public PartTestRepositoryTests()
        {
            _partTestRepository = GetRequiredService<IPartTestRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _partTestRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("cd2d84d3-6d16-441c-9fdd-f41451f29fd2"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _partTestRepository.GetCountAsync(
