...
public class AbpPocEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<AbpPocDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also AbpPocDbContextFactory for EF Core tooling. */
            options.UseNpgsql();
        });
