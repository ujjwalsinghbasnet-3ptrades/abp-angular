...
namespace AbpPoc.Web.Public.Menus;

public class AbpPocPublicMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public AbpPocPublicMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<AbpPocResource>();

        //Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                AbpPocPublicMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 1
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                AbpPocPublicMenus.ArticleSample,
