...
public class AbpPocDomainModule : AbpModule
{
        ...
        Configure<NewsletterOptions>(options =>
        {
            options.AddPreference(
                ...
                new NewsletterPreferenceDefinition(
                    LocalizableString.Create<AbpPocResource>("NewsletterPreference_Default"),
                    privacyPolicyConfirmation: LocalizableString.Create<AbpPocResource>("NewsletterPrivacyAcceptMessage")
                )
            );
        });
